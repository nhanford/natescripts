...
globus-url-copy -v 192.168.120.190:8190/media/gridTmp/rand.img /media/gridtmp/rand190.img &
globus-url-copy -v 192.168.120.191:8191/media/gridTmp/rand.img /media/gridtmp/rand191.img &
globus-url-copy -v 192.168.120.194:8194/media/gridTmp/rand.img /media/gridtmp/rand194.img &
globus-url-copy -v 192.168.120.195:8195/media/gridTmp/rand.img /media/gridtmp/rand195.img &
globus-url-copy -v 192.168.120.196:8196/media/gridTmp/rand.img /media/gridtmp/rand196.img
EOF
