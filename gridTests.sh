...
mkdir -p /tmp
{ time globus-url-copy -vb -cc 5 ftp://192.168.100.190:8190/tmp/zero190.img file:///dev/null ;} 2> 190Tpaced.txt &
{ time globus-url-copy -vb -cc 5 ftp://192.168.100.191:8191/tmp/zero191.img file:///dev/null ;} 2> 191Tpaced.txt &
{ time globus-url-copy -vb -cc 5 ftp://192.168.100.194:8194/tmp/zero194.img file:///dev/null ;} 2> 194Tpaced.txt &
{ time globus-url-copy -vb -cc 5 ftp://192.168.100.195:8195/tmp/zero195.img file:///dev/null ;} 2> 195Tpaced.txt &
{ time globus-url-copy -vb -cc 5 ftp://192.168.100.196:8196/tmp/zero196.img file:///dev/null ;} 2> 196Tpaced.txt 
sleep 100
EOF
