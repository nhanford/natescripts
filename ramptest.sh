...
do
    ...
    ssh nhanford@192.168.120.190 nuttcp -vv -T45 -u -Ri300m/20 192.168.100.192 &
    ssh nhanford@192.168.120.190 nuttcp -vv -T45 -i.1 -fparse 192.168.100.192 | tee T${i}00-T${i}00-190.txt &
    ssh nhanford@192.168.120.191 nuttcp -vv -T45 -i.1 -fparse 192.168.100.192 | tee T${i}00-T${i}00-191.txt
    #Final wait
done
